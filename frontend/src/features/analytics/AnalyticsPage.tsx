    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 font-mono">
        <div className="bg-[#161D2A] border border-[#1E293B] p-4 rounded-xl">
          ...
          <div className="text-2xl font-bold text-[#00C896] mt-1 font-mono-tabular">2.45</div>
        ...
        <div className="bg-[#161D2A] border border-[#1E293B] p-4 rounded-xl">
          ...
          <div className="text-2xl font-bold text-[#F6465D] mt-1 font-mono-tabular">-1.45%</div>
        ...
        <div className="bg-[#161D2A] border border-[#1E293B] p-4 rounded-xl">
          ...
          <div className="text-2xl font-bold text-[#3B82F6] mt-1 font-mono-tabular">1 : 2.85</div>
        ...
        <div className="bg-[#161D2A] border border-[#1E293B] p-4 rounded-xl">
          ...
          <div className="text-2xl font-bold text-[#F8FAFC] mt-1 font-mono-tabular">2.18</div>
