  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-[#1E293B] pb-3">
        <div>
          ...
          <p className="text-xs text-[#94A3B8] mt-0.5">
            Equity curve metrics, maximum drawdown analysis, win-rate breakdown, and risk metrics.
          </p>
        </div>
      ...
      <div className="bg-[#161D2A] border border-[#1E293B] rounded-lg p-6 text-center space-y-3">
        <PieChart className="w-12 h-12 text-[#3B82F6] mx-auto opacity-80" />
        <h2 className="text-base font-semibold text-[#F8FAFC]">Analytics Module Surface Configured</h2>
        <p className="text-xs text-[#94A3B8] max-w-xl mx-auto">
          Quantitative metrics calculation pipelines, drawdown distribution charts, and profit factor algorithms will be connected in analytics phase.
        </p>
      </div>
    </motion.div>
  );
