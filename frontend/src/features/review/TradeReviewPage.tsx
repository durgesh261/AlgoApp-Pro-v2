...
export const TradeReviewPage: React.FC = () => {
  ...
  const aiReview = detail?.aiReview || {
    tradeSummary: 'LONG trade on BTCUSD.P (1H) closed with Net PnL of $639.55 (WIN).',
    decisionSummary: 'Signal confirmed by Price Action Toolkit & Smart Money Concepts indicator engines.',
    strengths: ['Executed cleanly at demand zone retest with decision confidence of 94.5%.'],
    weaknesses: ['Slight slippage observed during volatile candle entry execution.'],
    riskAnalysis: 'Margin used was $3192.5 (6.4% of total equity) with effective risk-reward ratio of 2.0:1.',
    challengeImpact: 'Added +$639.55 to 20-Day Challenge balance, progressing towards 10% target.',
    improvementSuggestions: ['Maintain strict 1:2+ risk-to-reward ratio on all 1H and 15M demand zone entries.'],
  };
