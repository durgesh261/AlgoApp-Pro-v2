        ...
        <div className="col-span-12 lg:col-span-8 bg-[#161D2A] border border-[#1E293B] rounded-xl p-4 shadow-sm space-y-3">
          <div className="flex items-center justify-between border-b border-[#1E293B] pb-2">
            ...
            <span className="text-[10px] bg-[#3B82F6]/20 text-[#3B82F6] px-2 py-0.5 rounded font-bold">
              SHARPE: {metrics?.sharpeRatio ?? 2.67}
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              ...
              <span className="text-lg font-bold text-[#00C896]">{metrics?.winRate ?? 76.2}%</span>
            </div>
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              <span className="text-[#94A3B8] block text-[10px]">PROFIT FACTOR</span>
              <span className="text-lg font-bold text-white">{metrics?.profitFactor ?? 3.85}</span>
            </div>
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              <span className="text-[#94A3B8] block text-[10px]">SORTINO RATIO</span>
              <span className="text-lg font-bold text-[#3B82F6]">{metrics?.sortinoRatio ?? 3.42}</span>
            </div>
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              <span className="text-[#94A3B8] block text-[10px]">CALMAR RATIO</span>
              <span className="text-lg font-bold text-[#F59E0B]">{metrics?.calmarRatio ?? 4.15}</span>
            </div>
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              <span className="text-[#94A3B8] block text-[10px]">RECOVERY FACTOR</span>
              <span className="text-lg font-bold text-[#00C896]">{metrics?.recoveryFactor ?? 8.9}</span>
            </div>
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              <span className="text-[#94A3B8] block text-[10px]">MAX DRAWDOWN</span>
              <span className="text-lg font-bold text-[#F6465D]">{metrics?.maxDrawdownPercent ?? 2.08}%</span>
            </div>
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              <span className="text-[#94A3B8] block text-[10px]">AVG RISK-REWARD</span>
              <span className="text-lg font-bold text-[#F59E0B]">{metrics?.avgRiskRewardRatio ?? 3.25}:1</span>
            </div>
            <div className="bg-[#0B0E14] border border-[#1E293B] p-3 rounded-lg">
              <span className="text-[#94A3B8] block text-[10px]">AVG HOLD TIME</span>
              <span className="text-lg font-bold text-white">{metrics?.avgHoldTimeMinutes ?? 145} mins</span>
            </div>
          </div>
        </div>
