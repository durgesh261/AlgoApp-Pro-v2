...
import { mockWinRateData } from '../../mock/chartData';
import { PieChart } from 'lucide-react';

export const WinRateDonutChart: React.FC = () => {
  const { wins, losses, breakeven, winRatePercent, profitFactor } = mockWinRateData;
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-2 font-mono">
        ...
        <div className="relative w-32 h-32 flex items-center justify-center shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            <span className="text-xl font-bold text-[#00C896]">{winRatePercent}%</span>
